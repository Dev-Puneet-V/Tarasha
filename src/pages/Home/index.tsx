...
const Home: React.FC = () => {
  ...
  return (
    <div id='home-container'>
        ...
        <Image src={'https://res.cloudinary.com/dfoggertn/image/upload/v1696688104/test-1_yxjd2q.jpg'} className='home-img first-image'>
          <div className={`text-image-background flex justify-between items-center absolute bottom  right left sizing-border  flex wrap ${screenSize === 'sm' ? 'gap-1 p-4' : 'gap-3 p-8'}`}>
            ...
            <div className={`flex flex-col home-main-body-text ${screenSize === 'sm' ? 'gap-1' : 'gap-25px'}`}>
                <p className='text-styled'>Where Functionality Embraces Beauty :<br /> Your Ideal Space </p>
              ...
              <button className={`button ${screenSize === 'sm' ? '' : 'mb-8'}`} onClick={ () => navigate("/services")}>
                Get started
              </button>
            </div>
          </div>
      ...
      <div className={`flex flex-col items-center w-100 ${screenSize === 'sm' ? 'pt-4 gap-1' : 'pt-8 mt-2 gap-4'}`} style={{maxWidth: '1450px', margin: 'auto'}}>
        <p className={`text-styled-3 center ${screenSize === 'sm' ? '' : ''}`} style={{color: '#B87E1B !important'}}>About Us</p>
        <p className={`center ${screenSize === 'sm' ? 'ml-4 mr-4 pb-4 mb-2 justify' : 'ml-8 mr-8 pb-4 mb-8 pr-8'}`}>
      ...
      <div className='flex flex-col items-center w-full mt-8 pt-4 gap-2 pb-8' style={{maxWidth: '1450px', margin: 'auto'}}>
       ...
       <div className={`flex wrap space-around ml-4 mr-4 w-90 elements-home gap-3 mb-8 ${screenSize === 'sm' ? 'items-center' : ''}`}>
       ...
       <button className={`button button-dark ${screenSize === 'sm' ? 'mb-2' : 'mb-8'} mt-8`} onClick={ () => navigate("/services")}>
              Get started
          </button>
      </div>
      ...
      <div className='flex flex-col items-center w-100' style={{maxWidth: '1450px', margin: 'auto'}}>
        ...
        <p className={`center ${screenSize === 'sm' ? 'ml-4 mr-4 pb-4 justify' : 'ml-8 mr-8 pb-4 mb-8'}`}>
...
entire process. 
      ...
      <div>
      <div id='client-perspective' className='flex justify-center items-center pt-8 pb-4'>
...
{/* <div id='down-inverted-comma'>”</div> */}
      ...
      <div className={` ${screenSize === 'sm' ? 'pt-4 mt-4 pb-4 mb-4' : 'pt-8 mt-8 pb-8 mb-8'}`}>
        <p className={`center ml-8 mr-8 text-styled ${screenSize === 'sm' ? 'mb-2' : 'mb-8'}`}>
