...
const Services: React.FC = () => {
  ...
  return (
    <div id='home-container'>
        ...
        <div id='elements-container' className='mb-2 pb-2 pt-8' style={{maxWidth: '1450px', margin: 'auto'}}>
            <div className='flex flex-col pt-2 elements items-center mb-4 w-h100'>
                ...
                <button className='button button-dark mt-8 mb-2' onClick={ () => navigate("/services")}>Get Started</button>
            </div>
            <br />
        </div>
        <Image src={'https://res.cloudinary.com/dfoggertn/image/upload/v1696688708/test-2_wcj56w.jpg'} className='home-img'>
        </Image>
        <div id='services-container' className='flex flex-col items-center w-100 pt-8' style={{maxWidth: '1450px', margin: 'auto'}}>
        ...
        <br/>
        <ScopeOfWork />
        <div className='mb-8 mt-8 pt-8 pb-8' style={{maxWidth: '1450px', margin: 'auto'}}>
            <p className={`center ml-8 mr-8 text-styled-3 ${screenSize === 'sm' ? '' : 'mt-8 mb-4'}`}>
