    ...
    <div className='blog-item-container'>
      <div className='bc-ch'>
        ...
        {/* {screenSize === 'sm' &&  <div className=' w-100 h-25 blog-item-image relative blog-mini-image'>
          ...
          <div dangerouslySetInnerHTML={{ __html: content.split('</p>')[0] + content.split('</p>')[1] }} className='blog-item-content pt-2 pl-1' />
          </div>
      ...
      {screenSize === 'lg' && <div className='blog-item-image relative blog-mini-image'>
          <img src={imageUrl} />
          <div className='blog-image-shadow'></div>
        </div>}
      </div>
