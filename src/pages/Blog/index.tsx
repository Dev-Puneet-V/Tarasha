 ...
 const [currentPage, setCurrentPage] = React.useState<number>(1);
  ...
  return (
    <div id='home-container' className='blogss'>
        <div>
            <Image src={'https://res.cloudinary.com/dfoggertn/image/upload/v1696077777/TarashaWebsiteContent/Images/blogimages/banner/banner-test-3_qysaxp.jpg'} className='home-img'>
